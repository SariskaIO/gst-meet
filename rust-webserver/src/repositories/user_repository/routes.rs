...
pub async fn start_recording( 
    ...
    if audio_only { // audio only streaming
        ...
        --recv-video-scale-height={} \
        --room-name={} \
        --send-pipeline='uridecodebin uri=rtmp://your.rtmp.server/live/stream ! queue ! videoscale ! video/x-raw,width=640,height=360 ! videoconvert ! vp9enc buffer-size=1000 deadline=1 name=video' \
